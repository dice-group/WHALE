...
from .modules.data.labse import LaBSEEncoder, build_dbpedia_names, build_wikidata_names
...
BASE_INPUT_DIR = os.path.join(SOURCE_DIR, "inputs/EN_DE_15K/")

FOLDER_KG1 = os.path.join(
    BASE_INPUT_DIR, "embeddings/AEN_TransE_15K")
FOLDER_KG2 = os.path.join(
    BASE_INPUT_DIR, "embeddings/DE_TransE_15K")

BASE_OUTPUT_DIR = os.path.join(SOURCE_DIR, "outputs/")
OUTPUT_DIR = os.path.join(BASE_OUTPUT_DIR, "EN_DE_TransE_15K")
LABSE_CACHE_KG1 = os.path.join(BASE_OUTPUT_DIR, "cache/labse_EN_15K.npy")
LABSE_CACHE_KG2 = os.path.join(BASE_OUTPUT_DIR, "cache/labse_DE_15K.npy")

TRAIN_LINKS = os.path.join(BASE_INPUT_DIR, "links/train_links")
VAL_LINKS = os.path.join(BASE_INPUT_DIR, "links/valid_links")
TEST_LINKS = os.path.join(BASE_INPUT_DIR, "links/test_links")

DATA_DIR = os.path.join(BASE_INPUT_DIR, "")
